...
class StackedGCN(torch.nn.Module):  # modify the model
    ...
    def setup_layers(self):
        ...
        """
        self.layers = []
        self.args.layers = [self.input_channels] + self.args.layers + [
            self.output_channels]  # =[#features,16,16,16,#class]
    ...
    def forward(self, edges, features):
        ...
        # compute softmax along dim 1, prediction in [N,out_channel]
        return predictions
