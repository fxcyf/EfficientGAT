...
from utils import tab_printer, type_reader, load_data
...
def main():
    ...
    parser.add_argument("--data-name", nargs="?", default="cora", help="dataset name")
    parser.add_argument("--data-path", nargs="?", default="../input/cora/", help="dataset path")
    ...
    parser.add_argument("--clustering-path", nargs="?", default="../input/cora/clustering/",
                        help="Clustering result npy")
    parser.add_argument("--results-path", nargs="?", default="../results/cora_results/",
    ...
    parser.add_argument("--seed", type=int, default=67, help="Random seed for train-test split. Default is 42.")
    parser.add_argument('--no_cuda', action='store_true', default=False, help='Use CUDA training.')  # 无需带参数
    parser.add_argument("--epochs", type=int, default=1500, help="Number of training epochs. Default is 200.")
    parser.add_argument("--dropout", type=float, default=0.9, help="Dropout parameter. Default is 0.5.")
    parser.add_argument("--learning-rate", type=float, default=0.0015, help="Learning rate. Default is 0.01.")
    parser.add_argument("--test-ratio", type=float, default=0.1, help="Test data ratio. Default is 0.1.")
    parser.add_argument("--cluster-number", type=int, default=8, help="Number of clusters extracted. Default is 10.")
    ...
    parser.add_argument('--feature_type', nargs="?", default='relu',
    ...
    # load data and metis
    adj, features, labels, type_map = load_data(args.data_path, args.data_name)
    ...
    clustering_machine = ClusteringMachine(args, graph, adj, features, labels, type_map)
