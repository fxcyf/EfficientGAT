...
class SLiMPerformer(torch.nn.Module):
  ...
  def __init__(self, vocab_size, hidden_dim, n_layers, ffn_dim, n_heads,
    ...
    self._vocab_size = vocab_size   # word2vec vocabulary size
...
class SLiMPerformerLayer(torch.nn.Module):
  """Single SLiMPerformer layer (MLPs + Attention + LayerNorm)."""    # MLP Multilayer Perceptron: forward neural networks
