...
def main():
    ...
    parser.add_argument("--type-map-path", nargs="?", default=None,
    ...
    parser.add_argument("--clustering-path", nargs="?", default="../input/clustering/", help="Clustering result npy")
    parser.add_argument("--results-path", nargs="?", default="../results/results/",
    ...
    clustering_machine = ClusteringMachine(args, graph, graph, features, target)
